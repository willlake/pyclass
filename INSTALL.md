...
| CLASS source it compiles | `willlake/mochi_class_pyclass` @ `8102f2b`, pinned in `pyclass/mochiclass/_version.py` |
...
```
Downloading https://github.com/willlake/mochi_class_pyclass/archive/8102f2b.tar.gz to .../depends/tmp-class-mochiclass.tar.gz.
```
